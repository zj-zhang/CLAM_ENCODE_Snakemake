...
create_df_names <- function(gr, filename, record.names=NULL){
  ...
  df <- unique(df)
  df$starts = as.character(df$starts)
  df$ends = as.character(df$ends)
...
proximal200_df$starts =  as.character(proximal200_df$starts)
proximal200_df$ends =  as.character(proximal200_df$ends)
...
proximal500_df$starts =  as.character(proximal500_df$starts)
proximal500_df$ends =  as.character(proximal500_df$ends)
